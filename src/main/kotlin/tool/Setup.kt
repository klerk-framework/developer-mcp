...
private val createBasicSetupInstructions = """
    ...
    1. Edit build.gradle.kts according to the documentation (use the tool '$getDocumentation' and ask for  "${DocumentationSource.Dependencies.uri}"). Download the dependencies with Gradle.
